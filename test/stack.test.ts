...
describe('Stack - Highly Available 1-Tier Architecture', () => {
  let template: Template;

  beforeAll(() => {
    const app = new cdk.App();
    const stack = new HighlyAvailableStack(app, 'WebApp-Dev-MultiAZ-1TierInfra', {
  ...
  describe('Security Groups', () => {
    ...
    test('Creates two security groups total for true 1-tier architecture', () => {
